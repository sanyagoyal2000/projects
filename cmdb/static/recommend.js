$(function() {
  ...
  $('.movie-button').on('click',function(){
    var my_api_key = '34277c155e8341d536807380395f869a';
    var title = $('.movie').val();
    if (title=="") {
...
function load_details(my_api_key,title){
  $.ajax({
    type: 'GET',
    url:'https://api.themoviedb.org/3/search/movie?api_key={}&query={}'.format(my_api_key,title),
    async: false,
...
function get_movie_details(movie_id,my_api_key,movie_title,movie_title_org) {
  $.ajax({
    type:'GET',
    url:'https://api.themoviedb.org/3/movie/{}?api_key={}&language=en-US'.format(movie_id,my_api_key),
...
function get_individual_cast(movie_cast,my_api_key) {
    ...
    for(var cast_id in movie_cast.cast_ids){
      $.ajax({
        type:'GET',
        url:'https://api.themoviedb.org/3/person/{}?api_key={}&language=en-US'.format(movie_cast.cast_ids[cast_id],my_api_key),
        async:false,
...
function get_movie_cast(movie_id,my_api_key){
    ...
    $.ajax({
      type:'GET',
      url:"https://api.themoviedb.org/3/credit/{}?api_key={}".format(movie_id,my_api_key),
      async:false,
  ...
  function get_recommendations(movie_id, my_api_key) {
    ...
    $.ajax({
      type: 'GET',
      url: "https://api.themoviedb.org/3/movie/{}/recommendations?api_key={}&language=en-US&page=1".format(movie_id,my_api_key),
      async: false,
